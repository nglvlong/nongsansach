    ...
    <script>
      paypal.Buttons({
        ...
        onApprove: function(data, actions) {
          return actions.order.capture().then(function(orderData) {
            // Successful capture! For dev/demo purposes:
                ...
                window.location.replace('http://localhost/nongsansach/index.php?mod=displays/camon&thanhtoan=paypal');
        ...
        onCancle:function(data){
            window.location.replace('http://localhost/nongsansach/index.php?mod=displays/cart');
        }
