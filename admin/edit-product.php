...
if(isset($_GET['masp'])){
    ...
    if(isset($_POST['tensp'])){
        ...
        if(isset($_FILES['imagesps'])){
            ...
            foreach($file_names as $key => $value){
                mysqli_query($connect, "INSERT INTO nongsansach.thuvienanh (`MaSP`,`path`) values ('$id','$value')");
            }
            }
            }
        
        $sql_them ="UPDATE nongsansach.sanpham SET  TenSP='$tensp', AnhSP='$file_name', SoLuong='$soluong', GiaSP='$giasp', MoTa='$mota', MaDM='$madm', MaDV='$madv' where MaSP = $id_pro";
            ...
            <div class="col-md-6">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" placeholder="Input field" name="tensp" value="<?php echo $data['TenSP'] ?>">
                    </div>

                    <div class="form-group">
                        <label for="">Ảnh sản phẩm</label>
                        <input type="file" class="form-control" id="" placeholder="Input field" name="imagesp">
                        <img src="../uploads/<?php echo $data['AnhSP'] ?>" alt="" width="100">
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-4">
                               <a href="" class="thmbnail">
                                   <img src="../uploads/<?php echo $value['path'] ?>" alt="" style="max-height: 100px">
                               </a>
                           </div>
                           <?php }?>
                       </div> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" placeholder="Input field" name="soluong" value="<?php echo $data['SoLuong'] ?>">
                    </div>

                    <div class="form-group">
                        <label for="">Giá sản phẩm</label>
                        <input type="text" class="form-control" id="" placeholder="Input field" name="giasp" value="<?php echo $data['GiaSP'] ?>">
                    </div>

                    <div class="form-group">
                        <label for="">Mô tả</label>
                        <textarea name="mota" class="form-control" rows="3" required="required" ><?php echo $data['MoTa'] ?></textarea>
                    </div>
